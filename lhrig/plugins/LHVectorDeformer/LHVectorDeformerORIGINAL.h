...
class LHVectorDeformer : public MPxDeformerNode {
 public:
  LHVectorDeformer() {};
  ...
  static MObject aUseBaseMesh;
  // nAttrs
  static MObject aDeformationOrder;
  static MObject aCachePivots;
  static MObject aCacheWeights;
  static MObject aCacheWeightMesh;
  static MObject aCacheWeightCurves;
  static MObject aTValue;
  static MObject aTValueParent;
  static MObject aTWeightsBaby;

  static MObject aTWeights;
  static MObject aTWeightsParent;
  static MObject aTWeightsParentArray;
  static MObject aTAnimCurveU;
  static MObject aTAnimCurveUParent;
  static MObject aTAnimCurveV;
  static MObject aTAnimCurveVParent;
  static MObject aTPivot;
  static MObject aTPivotArray;
...
// pointers
  ...
  tempW, tempVal, tW, vW, nW, rW, slideUBasePointParam, slideVBasePointParam,
