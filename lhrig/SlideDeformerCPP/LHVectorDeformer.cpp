...
MObject LHVectorDeformer::aScaleAmount;
//////// cache attrs ////////
...
//        MPointArray curvePoints;
//        curves[0][0].getCVs(curvePoints, MSpace::kObject);
//        float myfloat = fabs(allPivotPositions[0][0][0].x);
//        float myfloat1 = fabs(allPivotPositions[0][0][0].y);
//        float myfloat2 = fabs(allPivotPositions[0][0][0].z);
//////
//        MGlobal::displayInfo(MString(" ")+myfloat+MString(" ")+myfloat1+MString(" ")+myfloat2);

      //Debug pivots
//    float myfloat = fabs(allPivots[0][1][1].x);
//    float myfloat1 = fabs(allPivots[0][1][1].y);
//    float myfloat2 = fabs(allPivots[0][1][1].z);
//    MGlobal::displayInfo(MString(" ")+myfloat+MString(" ")+myfloat1+MString(" ")+myfloat2+MString(" "));
        ...
        for(j = 0; j < allVals[1].size(); j++ )
        {
            if (allPivots.size() > mIndex)
            {
                if (allPivots[mIndex].size() > 1)
                {
                    ...
                    {
                        //Compose rotation
                        MQuaternion rotate(allVals[1][j],allPivots[mIndex][1][j]);
