...
class LHSlideDeformer : public MPxDeformerNode {
 public:
  ...
  static MObject aUOutWeights;
  static MObject aUOutWeightsParent;
  static MObject aUOutWeightsParentArray;
  static MObject aVOutWeights;
  static MObject aVOutWeightsParent;
  static MObject aVOutWeightsParentArray;
  static MObject aNOutWeights;
  static MObject aNOutWeightsParent;
  static MObject aNOutWeightsParentArray;
  static MObject aROutWeights;
  static MObject aROutWeightsParent;
  static MObject aROutWeightsParentArray;
