...
class vectorDeformerCmd():
    ...
    def __createWeights(self):
        ...
        for i in self.tNames:
            ...
            self.tWeights.append(self.returnWeightDeformer + "." + i +'TWeights')
        ...
        for i in self.rNames:
            ...
            self.rWeights.append(self.returnWeightDeformer + "." + i +'RWeights')
    ...
    def __connectSlideDeformer(self):
        ...
        #----connect weightDeformer weights
        ...
        for i in range(len(self.tAnimCurvesU)):
            ...
            cmds.connectAttr(self.tAnimCurvesU[i] + '.output',
                             self.returnWeightDeformer + '.uAnimCurveArray[' + str(i) +
                             '].uAnimCurve', 
                             force=True)
        #----ru
        for i in range(len(self.rAnimCurvesU)):
        ...
        for i in range(len(self.tAnimCurvesV)):
            ...
            cmds.connectAttr(self.tAnimCurvesV[i] + '.output',
                             self.returnWeightDeformer + '.vAnimCurveArray[' + str(i) +
                             '].vAnimCurve', 
                             force=True)
    ...
    def __create(self):
        """ This method creates the vectorDeformer setup """
        self.__getTypeArg()
        self.__getShape()
        self.__checkArgs()
