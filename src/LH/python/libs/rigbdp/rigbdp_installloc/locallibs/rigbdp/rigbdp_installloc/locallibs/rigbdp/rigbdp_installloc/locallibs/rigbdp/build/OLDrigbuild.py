...
################################### Usage ###################################
# parent_dir_path = r"C:\Users\harri\Documents\BDP\cha\teshi_TESTBUILD"
...
def new_scene(src_rig_file, local_build_dir, save_file=True):
    """
    ...
    Args:
        ...
        working_dir (str): The local directory where the build will happen
    ...
    """
    create_folder_structure(dir_path=local_build_dir)
    # Create a new Maya scene
    cmds.file(new=True, force=True)
    
    # Create the 'builds' directory if it doesn't exist
    builds_dir = os.path.join(local_build_dir, 'builds')
    ...
    file_path = os.path.join(builds_dir, src_rig_file)
