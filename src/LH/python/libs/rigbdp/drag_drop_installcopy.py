...
def install_python_library(modules=None, debug_path=False):
    ...
    install_script_dir = os.path.dirname(os.path.realpath(__file__))  # Directory of the script
    ...
    root_dir_name = os.path.basename(install_script_dir)  # Use the current directory's name
    ...
    shutil.copytree(install_script_dir, lib_dst)  # Copy the current directory
