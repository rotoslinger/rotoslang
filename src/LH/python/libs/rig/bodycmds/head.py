...
#===============================================================================
#CLASS:         create_head
#DESCRIPTION:   Creates head rig
#USAGE:         set arguments for head
...
class create_head():
    def __init__(self,
        ...
        type  name:                string
        param name:                the names of your head

        type  joint:               string array
        param joint:               the head joint that the rig will drive

        type  driver:              string
        param driver:              what the head will be attached to
                                    usually the chest joint but anything that
                                    exists will work

        type  global_scale:        string
        param global_scale:        what the head will be attached to
        ...
        type  ctl_size:             float
        param ctl_size:             a size for the head control
    ...
    def __create_bind_skel(self):
        """ create control and snap to head """
