...
def test(old_man=False, auto_load=True):
    ...
    L_upperLipMesh = "L_humanLidsUpper"
    L_upperLipBaseMesh = "L_humanLidsUpperBase"
    L_lowerLidMesh = "L_humanLidsLower"
    L_lowerLidBaseMesh = "L_humanLidsLowerBase"
    ...
    R_upperLipMesh = "R_humanLidsUpper"
    R_upperLipBaseMesh = "R_humanLidsUpperBase"
    R_lowerLidMesh = "R_humanLidsLower"
    R_lowerLidBaseMesh = "R_humanLidsLowerBase"
