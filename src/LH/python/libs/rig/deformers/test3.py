...
def faceTest():
    ...
    deformMesh="dogLipsLower"
    base="dogLipsLowerBase"
    ...
    slideUD = slideSimple.SlideSimple("LipSlide", geoToDeform=deformMesh, slidePatch=slidePatch, slidePatchBase=slidePatchBase, baseGeoToDeform=base)
    slideUD.create()
    # slideUD = slideSimple.SlideSimple("LRSlide", geoToDeform=deformMesh, slidePatch=slidePatch, slidePatchBase=slidePatchBase)
    cmds.setAttr("LipSlide.vAmount", -1)
    cmds.setAttr("LipSlide.uAmount", -1)
    ...
    stack = weightStack.WeightStack(name="TestWeights",
                                    ...
                                    isOutputKDoubleArray=True,
                                    controlSize = .9,
                                    controlOffset = [0,0.0,1.3],
                                    falloffElemStart = 1
                                    )
    stack.create()
    curveWeights.setFalloffDefaults()

    matDef = matrixDeformer.MatrixDeformer(name="testMatrixDeformer2",
                                    geoToDeform=deformMesh,
                                    # parent=stack.controls,
                                    # parent=stack.controls,
                                    centerToParent=True,
    ...
    stack = weightStack.WeightStack(name="TestWeights",
                                    ...
                                    isOutputKDoubleArray=True,
                                    controlSize = .5,
                                    controlOffset = [0,-1,2.3],
                                    falloffElemStart = 4
                                    )
    stack.create()
    curveWeights.setFalloffDefaults()

    matDef = matrixDeformer.MatrixDeformer(name="testMatrixDeformer3",
                                    geoToDeform=deformMesh,
                                    # parent=stack.controls,
                                    centerToParent=True,
                                    addAtIndex=0,
