...
//Name: facePackageTweaks.ma
//Last modified: Mon, Apr 01, 2019 04:28:25 PM
//Codeset: UTF-8
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" -0.065845233784514789 9.7195732957269634 82.648361074517112 ;
	setAttr ".r" -type "double3" -2.7383527296063201 0.19999999999792895 0 ;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "6B9FB100-0000-F5EB-5CA2-9E880003952C";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
...
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "6B9FB100-0000-F5EB-5CA2-9E8800039530";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "6B9FB100-0000-F5EB-5CA2-9E8800039531";
createNode displayLayerManager -n "layerManager";
	rename -uid "6B9FB100-0000-F5EB-5CA2-9E8800039532";
createNode displayLayer -n "defaultLayer";
	rename -uid "6B9FB100-0000-F5EB-5CA2-90D80003464E";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "6B9FB100-0000-F5EB-5CA2-9E8800039534";
...
createNode reference -n "faceModelPackageRN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		" 0"
		2 "|faceModelPackage:modelGeo|faceModelPackage:humanJaw" "visibility" " 0"
