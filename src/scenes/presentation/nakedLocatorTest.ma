...
//Last modified: Sat, Feb 23, 2019 10:42:16 AM
//Codeset: UTF-8
...
requires -nodeType "LHNakedLocator" "collision" "1.0";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 7.5545923169423688 5.2268198689067731 -8.5987926240410779 ;
	setAttr ".r" -type "double3" -26.138352729602044 138.59999999999931 0 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "7A6B6100-0001-5ECB-5C71-8FBB0000028C";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 11.472124739332925;
...
createNode LHNakedLocator -n "LHNakedLocator1" -p "transform1";
	...
	setAttr -k off ".v";
	setAttr ".fids" -type "doubleArray" 31 103 122 123 141 142 143
		 144 160 161 162 163 164 180 181 182 183 184 199
		 200 201 202 203 219 220 221 222 239 240 241 259
		 260 ;
	setAttr ".cr" 1;
	setAttr ".cg" 1;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "7A6B6100-0001-5ECB-5C71-93BB00000332";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
...
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "7A6B6100-0001-5ECB-5C71-93BB00000336";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "7A6B6100-0001-5ECB-5C71-93BB00000337";
createNode displayLayerManager -n "layerManager";
	rename -uid "7A6B6100-0001-5ECB-5C71-93BB00000338";
	setAttr ".dli[1]"  1;
	setAttr -s 2 ".dli";
createNode displayLayer -n "defaultLayer";
	rename -uid "7A6B6100-0001-5ECB-5C71-8FBB0000029A";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "7A6B6100-0001-5ECB-5C71-93BB0000033A";
